...
namespace Proyecto_POO
{
    public partial class Inicio : Form
    {
        ...
        public Inicio(List<Libro> LibrosServer, List<Libro> LibrosUsuario,string usuario)
        {
            InitializeComponent();
        ...
        private void buttonMiCuenta1_Click(object sender, EventArgs e)
        {
        ...
        private void buttonMejoresLibros1_Click(object sender, EventArgs e)
        {
        ...
        private void buttonInicio1_Click(object sender, EventArgs e)
        {
